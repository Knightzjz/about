...
## NLP
- ``ACL`` [Word Segmentation by Separation Inference for East Asian Languages](https://aclanthology.org/2022.findings-acl.309/), Yu Tong, Jingzhi Guo, **Jizhe Zhou**, Ge Chen, Guokai Zheng
- ``TNNLS`` [Separation inference: A unified framework for word segmentation in east asian languages](Yu Tong, Jingzhi Guo, Jizhe Zhou), Yu Tong, Jingzhi Guo, **Jizhe Zhou**
